...
class Node3:
  ...
  def rtinit3(self):
    ...
    for n in self.neighbors:
      currentID = n.id
      minCost = []
      minCost.append(self.distanceTable[3][0])
      minCost.append(self.distanceTable[3][1])
      minCost.append(self.distanceTable[3][2])
      minCost.append(self.distanceTable[3][3])
      self.myPacketsToSend.append(rtpkt(3,currentID,minCost))

  def rtupdate3(self, rtpacket):
    #unpack packet
